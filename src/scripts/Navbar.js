...
function Navbar() {
  ...
  return (
    <>
      ...
      {/* ── Top Bar ───────────────────────────────────────────────────────── */}
      {/* Hidden on mobile — info moves to mobile menu instead */}
      <div
        className="nb-topbar"
      ...
      >
        ...
        >
          ...
          >
            <span style={{ width: "5px", height: "5px", borderRadius: "50%", backgroundColor: C.gold, opacity: 0.8 }} />
