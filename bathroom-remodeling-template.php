  ...
  <div style="position:relative; z-index:2; max-width:1280px; margin:0 auto; padding:80px 24px 60px; width:100%;">
    <div style="max-width:740px;">
      <div style="display:inline-flex; align-items:center; gap:12px; margin-bottom:24px;">
        ...
        <span style="font-family:'Amino',sans-serif; font-size:10px; font-weight:700; letter-spacing:0.25em; text-transform:uppercase; color:#C9A84C;">Bathroom Remodeling · Maryland</span>
      </div>
      ...
      <p style="font-family:'Amino',sans-serif; font-size:clamp(1rem,2vw,1.15rem); color:rgba(255,255,255,0.78); line-height:1.78; max-width:580px; margin-bottom:40px;">
    ...
    <div class="br-fade-up">
      <div style="border-radius:8px; overflow:hidden; aspect-ratio:3/4; background:linear-gradient(135deg,#0d1b2a,#415a77); position:relative;">
        ...
        <div style="position:absolute; bottom:0; left:0; right:0; padding:16px 18px; background:linear-gradient(transparent,rgba(11,31,51,0.88));">
          <span style="font-family:'Amino',sans-serif; font-size:10px; font-weight:600; letter-spacing:0.14em; text-transform:uppercase; color:rgba(255,255,255,0.6);">Precision Tile Detail</span>
        </div>
      </div>
    </div>
  </div>
...
<section style="background:#fff; padding:96px 0;">
  <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
    <div style="text-align:center; margin-bottom:56px;" class="br-fade-up">
      ...
      <h2 style="font-family:'AkzidenzGrotesk',sans-serif; font-size:clamp(1.8rem,3.5vw,2.6rem); font-weight:900; color:#0d1b2a; line-height:1.2; max-width:520px; margin:0 auto;">
    ...
    <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:16px;" class="br-services-grid">
      ...
      foreach ($svcs as $svc): ?>
        <div class="br-service-item" style="display:flex; align-items:flex-start; gap:14px; padding:20px 18px; border-radius:8px; border:1px solid rgba(11,31,51,0.08); background:#d1d5db;">
          ...
          <span style="font-family:'Amino',sans-serif; font-size:12px; font-weight:700; letter-spacing:0.04em; color:#0d1b2a; line-height:1.5; padding-top:9px;"><?php echo $svc['label']; ?></span>
        </div>
      <?php endforeach; ?>
    </div>
  ...
  <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
    ...
    <div style="max-width:620px; margin:0 auto;" class="br-pricing-wrap">
      <div style="background:rgba(201,168,76,0.06); border:1px solid rgba(201,168,76,0.35); border-radius:10px; padding:48px 40px; position:relative; overflow:hidden; transition:box-shadow 0.25s, transform 0.25s;" onmouseover="this.style.boxShadow='0 20px 56px rgba(0,0,0,0.35)';this.style.transform='translateY(-4px)';" onmouseout="this.style.boxShadow='none';this.style.transform='none';">
        ...
        <p style="font-family:'Amino',sans-serif; font-size:10px; font-weight:700; letter-spacing:0.22em; text-transform:uppercase; color:#C9A84C; margin:0 0 12px;">Complete Bathroom Renovation</p>
        <div style="display:flex; align-items:flex-end; gap:12px; margin-bottom:8px;">
          <p style="font-family:'AkzidenzGrotesk',sans-serif; font-size:3.5rem; font-weight:900; color:#C9A84C; margin:0; line-height:1;">$18,000</p>
          <span style="font-family:'Amino',sans-serif; font-size:1.1rem; color:rgba(255,255,255,0.4); font-weight:500; margin-bottom:8px;">starting at</span>
        </div>
        <div style="display:flex; gap:20px; margin-bottom:36px;">
          <span style="font-family:'Amino',sans-serif; font-size:11px; font-weight:600; letter-spacing:0.1em; text-transform:uppercase; color:rgba(255,255,255,0.4); display:flex; align-items:center; gap:6px;">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
          <?php foreach(['Full tile demolition & prep','Tile installation (all formats)','Shower conversion & glass enclosure','Vanity, sink & faucet install','Toilet replacement','Mirror & lighting upgrades','Flooring — tile or LVP','Painting & waterproofing'] as $item): ?>
            <div style="display:flex; align-items:center; gap:10px; font-family:'Amino',sans-serif; font-size:14px; color:rgba(255,255,255,0.65);">
        ...
        <div style="margin-top:36px; padding-top:28px; border-top:1px solid rgba(255,255,255,0.08);">
          <p style="font-family:'Amino',sans-serif; font-size:13px; color:rgba(255,255,255,0.35); margin:0; line-height:1.65;">
...
<section style="background:#FDF8EC; padding:96px 0;">
  <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
    <div style="text-align:center; margin-bottom:52px;" class="br-fade-up">
      ...
      <p style="font-family:'Amino',sans-serif; font-size:14px; color:#2f2f2f; opacity:0.5; margin-top:12px;">Drag the slider left or right to reveal each transformation.</p>
    </div>
        ...
        <div>
          ...
          <div style="margin-top:14px; padding:0 4px; display:flex; align-items:center; justify-content:space-between;">
            <div>
              ...
              <p style="font-family:'Amino',sans-serif
              ; font-size:12px; color:#415a77; margin:3px 0 0;"><?php echo $p['location']; ?></p>
            </div>
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;" class="br-trust-grid">
        ...
        foreach ($trust as $t): ?>
          <div class="br-trust-item" style="display:flex; gap:16px; padding:24px 22px; border-radius:8px; border-left:3px solid #C9A84C; background:#FDF8EC; border-top:1px solid rgba(201,168,76,0.15); border-right:1px solid rgba(201,168,76,0.15); border-bottom:1px solid rgba(201,168,76,0.15);">
            ...
            <div>
              <p style="font-family:'Amino',sans-serif; font-size:12px; font-weight:800; letter-spacing:0.05em; color:#0d1b2a; margin:0 0 8px;"><?php echo $t['title']; ?></p>
              <p style="font-family:'Amino',sans-serif; font-size:13px; color:#2f2f2f; opacity:0.68; line-height:1.65; margin:0;"><?php echo $t['body']; ?></p>
            </div>
          </div>
        <?php endforeach; ?>
      </div>
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;" class="br-trust-grid">
      ...
      foreach ($testimonials as $t): ?>
        <div class="br-testimonial" style="background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.08); border-radius:8px; padding:32px 28px;">
          ...
          <blockquote style="font-family:'AkzidenzGrotesk',sans-serif; font-size:15px; font-style:italic; color:rgba(255,255,255,0.8); line-height:1.78; margin:0 0 20px;">"<?php echo $t['q']; ?>"</blockquote>
          <div style="display:flex; align-items:center; justify-content:space-between; padding-top:16px; border-top:1px solid rgba(255,255,255,0.07);">
            ...
            <span style="font-family:'Amino',sans-serif; font-size:9px; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; background:rgba(201,168,76,0.12); color:#C9A84C; padding:4px 10px; border-radius:3px; border:1px solid rgba(201,168,76,0.2);">Bathroom Remodel</span>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
...
<section style="background:#C9A84C; padding:56px 24px;">
  <div style="max-width:1280px; margin:0 auto; display:flex; align-items:center; justify-content:space-between; gap:32px; flex-wrap:wrap;" class="br-cta-flex">
    <div>
      ...
      <h2 style="font-family:'AkzidenzGrotesk',sans-serif; font-size:clamp(1.6rem,3vw,2.4rem); font-weight:900; color:#0d1b2a; line-height:1.15; margin:0 0 6px;">Ready to Elevate Your Bathroom?</h2>
      <p style="font-family:'Amino',sans-serif; font-size:14px; color:rgba(11,31,51,0.65); margin:0;">Average response: 24–48 hours. No pressure. Just clarity.</p>
    </div>
