  ...
  <div style="position:relative; z-index:2; max-width:1280px; margin:0 auto; padding:80px 24px 60px; width:100%;">
    <div style="max-width:760px;">
      <div style="display:inline-flex; align-items:center; gap:12px; margin-bottom:24px;">
        ...
        <span style="font-family:'Amino',sans-serif; font-size:10px; font-weight:700; letter-spacing:0.25em; text-transform:uppercase; color:#C9A84C;">Flooring Installation · Maryland</span>
      </div>
      ...
      <p style="font-family:'Amino',sans-serif; font-size:clamp(1rem,2vw,1.15rem); color:rgba(255,255,255,0.78); line-height:1.78; max-width:600px; margin-bottom:40px;">
    ...
    <div class="fl-fade-up">
      <div style="border-radius:8px; overflow:hidden; aspect-ratio:3/4; background:linear-gradient(135deg,#0d1b2a,#415a77); position:relative;">
        ...
        <div style="position:absolute; bottom:0; left:0; right:0; padding:16px 18px; background:linear-gradient(transparent,rgba(11,31,51,0.88));">
          <span style="font-family:'Amino',sans-serif; font-size:10px; font-weight:600; letter-spacing:0.14em; text-transform:uppercase; color:rgba(255,255,255,0.6);">Installation in Progress</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
    <div style="text-align:center; margin-bottom:52px;" class="fl-fade-up">
      <div style="display:inline-flex; align-items:center; gap:12px; margin-bottom:16px;">
        ...
        <span style="font-family:'Amino',sans-serif; font-size:10px; font-weight:700; letter-spacing:0.25em; text-transform:uppercase; color:#C9A84C;">Materials We Install</span>
        <div style="width:36px; height:1px; background:#C9A84C;"></div>
      </div>
    ...
    $materials = [
      [
        ...
        'img'     => '/wp-content/uploads/2026/05/LVP-scaled.jpg',
        'detail1' => '/wp-content/uploads/2026/05/LVP1-scaled.jpg',
        'detail2' => '/wp-content/uploads/2026/05/LVP2-scaled.jpg',
      ...
      [
        ...
        'img'     => '/wp-content/uploads/2026/05/HardwoodFloor3-scaled.jpg',
        'detail1' => '/wp-content/uploads/2026/05/HardwoodFloor2-scaled.jpg',
        'detail2' => '/wp-content/uploads/2026/05/HardwoodFloor-scaled.jpg',
      ...
      [
        ...
        'img'     => '/wp-content/uploads/2026/05/VinylFlooring-scaled.jpg',
        'detail1' => '/wp-content/uploads/2026/05/VinylFlooring2.jpg',
        'detail2' => '/wp-content/uploads/2026/05/VinylFlooring3-scaled.jpg',
      ...
      [
        ...
        'img'     => '/wp-content/uploads/2026/05/CeramicInstallation-scaled.jpg',
        'detail1' => '/wp-content/uploads/2026/05/CeramicInstallation2-scaled.jpg',
        'detail2' => '/wp-content/uploads/2026/05/CeramicInstallation3-scaled.jpg',
      ...
      [
        ...
        'img'     => '/wp-content/uploads/2026/05/CarpetInstallation-scaled.jpg',
        'detail1' => '/wp-content/uploads/2026/05/CarpetFlooring2-scaled.jpeg',
        'detail2' => '/wp-content/uploads/2026/05/CarpetFlooring3-scaled.jpg',
      ...
      [
        ...
        'img'     => '/wp-content/uploads/2026/05/LaminateFlooring-scaled.jpeg',
        'detail1' => '/wp-content/uploads/2026/05/LaminateFlooring2-scaled.jpg',
        'detail2' => '/wp-content/uploads/2026/05/LamiteFlooring3-scaled.jpg',
    ...
    foreach ($materials as $i => $m): ?>
      <div class="fl-tab-panel<?php echo $i === 0 ? ' active' : ''; ?>" id="fl-panel-<?php echo $i; ?>"
        ...
        <!-- Left: copy -->
        <div>
          <p style="font-family:'Amino',sans-serif; font-size:10px; font-weight:700; letter-spacing:0.22em; text-transform:uppercase; color:#C9A84C; margin:0 0 12px;"><?php echo $m['name']; ?></p>
          <h3 style="font-family:'AkzidenzGrotesk',sans-serif; font-size:clamp(1.5rem,3vw,2.2rem); font-weight:900; color:#fff; line-height:1.2; margin-bottom:20px;"><?php echo $m['tagline']; ?></h3>
          <p style="font-family:'Amino',sans-serif; font-size:15px; color:rgba(255,255,255,0.65); line-height:1.8; margin-bottom:28px;"><?php echo $m['body']; ?></p>
          <ul style="list-style:none; padding:0; margin:0 0 28px; display:flex; flex-direction:column; gap:12px;">
            <?php foreach ($m['points'] as $pt): ?>
              <li style="display:flex; align-items:flex-start; gap:12px; font-family:'Amino',sans-serif; font-size:14px; color:rgba(255,255,255,0.7); line-height:1.55;">
          ...
          <div style="padding:14px 18px; border-radius:6px; background:rgba(255,255,255,0.04); border-left:3px solid #C9A84C;">
            <p style="font-family:'Amino',sans-serif; font-size:10px; font-weight:700; letter-spacing:0.14em; text-transform:uppercase; color:#C9A84C; margin:0 0 5px;">Best For</p>
            <p style="font-family:'Amino',sans-serif; font-size:13px; color:rgba(255,255,255,0.55); margin:0; line-height:1.55;"><?php echo $m['best']; ?></p>
          </div>
          <a href="/contact" style="display:inline-flex; align-items:center; gap:10px; margin-top:28px; background:#C9A84C; color:#0d1b2a; font-family:'Amino',sans-serif; font-size:11px; font-weight:800; letter-spacing:0.12em; text-transform:uppercase; text-decoration:none; padding:0 28px; height:48px; border-radius:4px; transition:background 0.2s;" onmouseover="this.style.background='#DFB95A';" onmouseout="this.style.background='#C9A84C';">
...
<section style="background:#d1d5db; padding:96px 0;">
  <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
    <div style="text-align:center; margin-bottom:56px;" class="fl-fade-up">
      <div style="display:inline-flex; align-items:center; gap:12px; margin-bottom:16px;">
        <div style="width:36px; height:1px; background:#C9A84C;"></div>
        <span style="font-family:'Amino',sans-serif; font-size:10px; font-weight:700; letter-spacing:0.25em; text-transform:uppercase; color:#C9A84C;">Why Our Installation</span>
        <div style="width:36px; height:1px; background:#C9A84C;"></div>
      </div>
      <h2 style="font-family:'AkzidenzGrotesk',sans-serif; font-size:clamp(1.8rem,3.5vw,2.6rem); font-weight:900; color:#0d1b2a; line-height:1.2; max-width:600px; margin:0 auto;">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; max-width:1000px; margin:0 auto;" class="fl-why-grid">
      ...
      foreach ($why as $w): ?>
        <div class="fl-why-item" style="display:flex; gap:16px; padding:24px 22px; border-radius:8px; border-left:3px solid #C9A84C; background:#FDF8EC; border-top:1px solid rgba(201,168,76,0.15); border-right:1px solid rgba(201,168,76,0.15); border-bottom:1px solid rgba(201,168,76,0.15);">
          ...
          <div>
            <p style="font-family:'Amino',sans-serif; font-size:12px; font-weight:800; letter-spacing:0.05em; color:#0d1b2a; margin:0 0 8px;"><?php echo $w['title']; ?></p>
            <p style="font-family:'Amino',sans-serif; font-size:13px; color:#2f2f2f; opacity:0.68; line-height:1.65; margin:0;"><?php echo $w['body']; ?></p>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
...
<section style="background:#fff; padding:96px 0;">
  <div style="max-width:1280px; margin:0 auto; padding:0 24px;">
    <div style="text-align:center; margin-bottom:52px;" class="fl-fade-up">
      <div style="display:inline-flex; align-items:center; gap:12px; margin-bottom:16px;">
        <div style="width:36px; height:1px; background:#C9A84C;"></div>
        <span style="font-family:'Amino',sans-serif; font-size:10px; font-weight:700; letter-spacing:0.25em; text-transform:uppercase; color:#C9A84C;">Flooring Portfolio</span>
        <div style="width:36px; height:1px; background:#C9A84C;"></div>
      </div>
      ...
      foreach ($gallery as $item): ?>
        <div class="fl-gallery-item" style="<?php echo $item['span']; ?> background:linear-gradient(135deg,#0d1b2a,#415a77);">
          ...
          <div class="fl-gallery-caption">
            <p style="font-family:'Amino',sans-serif; font-size:12px; font-weight:700; color:#fff; margin:0;"><?php echo $item['label']; ?></p>
            <p style="font-family:'Amino',sans-serif; font-size:11px; color:#C9A84C; margin:3px 0 0;"><?php echo $item['location']; ?></p>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
...
<section style="background:#C9A84C; padding:56px 24px;">
  <div style="max-width:1280px; margin:0 auto; display:flex; align-items:center; justify-content:space-between; gap:32px; flex-wrap:wrap;" class="fl-cta-flex">
    <div>
      ...
      <h2 style="font-family:'AkzidenzGrotesk',sans-serif; font-size:clamp(1.6rem,3vw,2.4rem); font-weight:900; color:#0d1b2a; line-height:1.15; margin:0 0 6px;">Request a Free Flooring Estimate.</h2>
